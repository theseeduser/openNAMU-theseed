...
with get_db_connect() as conn:
    ...
    print('0.0.0.0:' + server_set['port'] + '에서 실행 중...')
...
# Func-list
# /list/document/old
app.route('/OldPages')(list_old_page)
app.route('/OldPages/<int:num>')(list_old_page)
...
@app.route('/BlockHistory/<regex("user"):tool>/<name>')
@app.route('/BlockHistory/<regex("admin"):tool>/<name>')
